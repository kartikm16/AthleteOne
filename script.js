...
function initializeCharts() {
        ...
        new Chart(performanceCtx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Speed (km/h)',
                        data: performanceData.historicalData.speed,
                        borderColor: '#ff6b6b',
                    ...
                    {
                        label: 'Stamina (%)',
                        data: performanceData.historicalData.stamina,
                        borderColor: '#4ecdc4',
                    ...
                    {
                        label: 'Strength (kg)',
                        data: performanceData.historicalData.strength.map(val => val / 2), // Scale for visibility
                        borderColor: '#f093fb',
    ...
    if (trainingCtx) {
        new Chart(trainingCtx, {
            type: 'doughnut',
            data: {
                labels: ['Speed Training', 'Strength Training', 'Agility Drills', 'Stamina Building'],
                datasets: [{
                    data: [30, 25, 20, 25],
                    backgroundColor: [
                        '#ff6b6b',
